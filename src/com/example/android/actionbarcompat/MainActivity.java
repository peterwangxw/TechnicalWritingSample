    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_locations:
                ...
                Intent locationIntent = new Intent(getApplicationContext(), LPLocationActivity.class);
                startActivity(locationIntent);
                break;
            case R.id.menu_offer:
                Toast.makeText(this, "Tapped offer", Toast.LENGTH_SHORT).show();
                Intent offerIntent = new Intent(getApplicationContext(), LPMessageActivity.class);
                startActivity(offerIntent);
                break;
            case R.id.menu_attributes:
                Toast.makeText(this, "Tapped offer", Toast.LENGTH_SHORT).show();
                Intent attributeIntent = new Intent(getApplicationContext(), AttributesActivity.class);
